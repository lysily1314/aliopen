 ...
 * @property \AliCrossopen\entity\order\QueryOrderRefundParams needTimeOutInfo
 * @property \AliCrossopen\entity\order\QueryOrderRefundParams needOrderRefundOperation
 */
